...
import { ArrowRight, CheckCircle, Lock, Zap, Shield } from 'lucide-react'
...
export default function VariantC() {
  ...
  useEffect(() => {
    trackEvent('screen_view', 'C', currentScreen)
  }, [currentScreen])
    ...
    landing: (
      <div className="min-h-screen bg-gradient-to-br from-primary/5 to-accent/5 flex items-center justify-center px-4">
        <div className="max-w-lg w-full">
          ...
          <Button
            onClick={() => {
              trackEvent('button_click', 'C', 'landing', { button: 'create_account' })
    ...
    features: (
      <div className="min-h-screen bg-gradient-to-br from-primary/5 to-accent/5 flex items-center justify-center px-4">
        <div className="max-w-lg w-full">
          ...
          <Button
            onClick={() => {
              trackEvent('button_click', 'C', 'features', { button: 'continue' })
        ...
        <div className="max-w-lg w-full">
          ...
          <div className="bg-secondary/30 border border-secondary/50 rounded-lg p-6 mb-6">
            ...
            <p className="text-sm text-foreground mb-3">
              At FlowFit, we take your privacy seriously. Your personal health data is sensitive, and we're committed to protecting it with the highest standards.
            </p>
          ...
          <div className="flex gap-3">
            <Button
              ...
              className="flex-1"
              onClick={() => {
                trackEvent('button_click', 'C', 'permission', { button: 'cancel' })
                setCurrentScreen('landing')
              }}
            >
              Cancel
            ...
            <Button
              onClick={() => {
                trackEvent('button_click', 'C', 'permission', { button: 'agree_continue' })
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 to-accent/5 flex items-center justify-center px-4">
        <div className="max-w-lg w-full text-center">
          ...
          <a
            ...
            onClick={() => trackEvent('button_click', 'C', 'thankyou', { button: 'take_survey' })}
